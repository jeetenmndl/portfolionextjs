...
const Projects = () => {
  ...
  return (
    <div className='lg:grid lg:grid-cols-5'>
        ...
        <div className="hidden border border-gray-800 col-span-2 px-4 py-6 lg:flex flex-col gap-4">
        ...
        {/* show projects here */}
        <div className="hidden lg:block border border-gray-800 col-span-3 p-4">
        ...
        <div className="lg:hidden border border-gray-800 col-span-3 lg:p-4">
